...
function NodeContent(props: NodeContentRendererProps) {
    if ((props.node.type === CanvasNodeType.Config || props.node.type === CanvasNodeType.ReferenceSet) && props.renderNodeContent) return props.renderNodeContent(props.node);
